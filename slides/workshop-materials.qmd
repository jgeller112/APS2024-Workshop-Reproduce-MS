...
1.  Right-click on the following link and select *Save Link As...*: [my-reproducible-manuscript.zip](https://github.com/UtrechtUniversity/workshop-reproducible-manuscripts/raw/main/my-reproducible-manuscript.zip)
